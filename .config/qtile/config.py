...
bar_height = 16
font_size = int(round(float(bar_height) * 6 / 7))
screens = [
    Screen(
        top = bar.Bar(
                    [
                        widget.GroupBox(borderwidth=2,
                            font='Consolas',fontsize=font_size,
                            padding=1, margin_x=1, margin_y=1),
                        widget.Sep(),
                        widget.WindowName(
                            font='Consolas',fontsize=font_size, margin_x=6),
                        widget.Sep(),
                        widget.Battery(
                            font='Consolas',fontsize=font_size, margin_x=6),
                        widget.Sep(),
                        ...
                        widget.Clock('%H:%M:%S %d.%m.%Y',
                            font='Consolas', fontsize=font_size, padding=6),
                    ],
                    bar_height,
                ),
    ),
